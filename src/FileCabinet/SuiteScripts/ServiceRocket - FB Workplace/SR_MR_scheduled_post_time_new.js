 ...
 */
define(['N/record', 'N/search', 'N/email', 'N/runtime','./Library/sr_post_helper.js'],
    /**
     * @param{record} record
     * @param{search} search
     */
    function(record, search, email, runtime,libHelper){
        /**
        ...
        function map(mapContext) {
            try {
                ...
                libHelper.CreateJournal(subsidaryD,classD,departmentD,locationD,lvCurrency,id,finalLineMemo,accountDr,Number(finalAmount),accountCr,billCbk);
            }catch(e){
                log.debug('Error', e);
            }
        }
