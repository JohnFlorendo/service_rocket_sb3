...
function(runtime,libHelper) {
    ...
    function map(context) {
        try {
            ...
            switch (objMessage.type) {
                case 'timeoffrequest':
                    errorMessage = '';//sendTimeOffRequest(objMessage,wpConfig.Host,wpConfig.TokenKey);
                    break;
                case 'timebill' :
                    errorMessage = '';//sendTimeEntries(objMessage,wpConfig.Host,wpConfig.TokenKey);
                    break;
                case 'weeklytimebill' :
                    errorMessage = '';//sendIncompleteTimeSheet(objMessage,wpConfig.Host,wpConfig.TokenKey);
                    break;
            }
    ...
    function sendTimeOffRequest(objRequestTimeOff,Host,TokenKey) {
        var stResult = '';
        try{
    ...
    function sendTimeEntries(objTimeEntries,Host,TokenKey) {
        var stResult = '';
        try {
    ...
    function sendIncompleteTimeSheet(objTimeSheet,Host,TokenKey) {
        var stResult = '';
        try{
