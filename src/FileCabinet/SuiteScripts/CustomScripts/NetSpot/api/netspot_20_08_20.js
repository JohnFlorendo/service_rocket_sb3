	...
	generateHubCard = function(requestParams, card){
		...
		res.forEach(function(result) {
			...
			if(newRec.getLineCount({sublistId: 'closed'}) > 0){
				...
				var recSo = record.load({type: 'salesorder', id: newRec.getSublistValue({sublistId: 'closed', fieldId: 'closeid', line: 0})});
				...
				objProperty.dataType = 'STRING';
				objProperty.value = recSo.getText({fieldId: 'total'});
				arrProperties.push(objProperty);
				
				objProperty.label = 'Amount (Before GST)';
				objProperty.dataType = 'STRING';
				objProperty.value = recSo.getText({fieldId: 'custpage_subtotal'});
				arrProperties.push(objProperty);
				
				objProperty.label = 'Tax Amount';
				objProperty.dataType = 'STRING';
				objProperty.value = recSo.getText({fieldId: 'custpage_taxamount'});
				arrProperties.push(objProperty);
				
				objProperty.label = 'Amount Invoiced';
				objProperty.dataType = 'STRING';
				objProperty.value = recSo.getText({fieldId: 'custpage_amountinvoiced'});
				arrProperties.push(objProperty);
				
				objProperty.label = 'Amount Remaining';
				objProperty.dataType = 'STRING';
				objProperty.value = recSo.getText({fieldId: 'custpage_amountremaining'});
				arrProperties.push(objProperty);
