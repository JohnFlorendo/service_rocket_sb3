SELECT employee.externalid
	...
	, employee.custentity_atlas_chr_hr_rep AS hrmanagerid
...
INNER JOIN employeestatus
	ON employee.employeestatus = employeestatus.id
...
WHERE   employeestatus.category = 2 /*Actively Employed*/
	AND employee.isinactive = 'F'
	AND employee.custentity_atlas_chr_hr_rep = {{id}}